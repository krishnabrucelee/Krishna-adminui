        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function () {
                ...
                if ($(this).is('li:has(ul)')) {
                    ...
                    $(this).find(' > span > span').addClass('glyphicon-chevron-down m-r-xs');
            ...
            if (options.addable) {
                ...
                $(easyTree).find('.easy-tree-toolbar .create > button').attr('title', options.i18n.addTip).click(function () {
                    ...
                    $(createInput).find('.confirm').click(function () {
                        ...
                        var item = $('<li><span><span class="glyphicon "></span><a>' + $(createInput).find('input').val() + '</a> </span></li>');
                        ...
                        if (selected.length <= 0) {
                            ...
                            if ($(selected).hasClass('parent_li')) {
                                ...
                                $(selected).addClass('parent_li').find(' > span > span').addClass('glyphicon-chevron-up m-r-xs').removeClass('glyphicon-chevron-up');
                    ...
                    if (selected.length <= 0) {
                        ...
                        $(easyTree).find('.alert .alert-content .confirm').on('click', function () {
                            ...
                            if ($(selected).parent('ul').find(' > li').length <= 1) {
                                $(selected).parents('li').removeClass('parent_li').find(' > span > span').removeClass('glyphicon-chevron-up').addClass('glyphicon-chevron-down');
            ...
            $(easyTree).delegate('li.parent_li > span', 'click', function (e) {
                ...
                input.val($(this).text());
                input.trigger('input');
                input1.val($(this).parent().attr("id"));
                ...
                if (children.is(':visible')) {
                    ...
                    $(this).attr('title', options.i18n.expandTip)
                            .find(' > span.glyphicon')
                            .addClass('glyphicon-chevron-down m-r-xs')
                    ...
                    $(this).attr('title', options.i18n.collapseTip)
                            .find(' > span.glyphicon')
                            .addClass('glyphicon-chevron-up m-r-xs')
            ...
            if (options.selectable) {
                ...
                $(easyTree).find('li > span > a').click(function (e) {
                    ...
                    input.val($(this).text());
                    input.trigger('input');
                    input1.val($(this).parent().parent().attr("id"));
                    input1.trigger('input');
