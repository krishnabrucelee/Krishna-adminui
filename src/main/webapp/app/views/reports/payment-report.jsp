...
<div ui-view data-ng-controller="reportCtrl">
    <div data-ng-include src="'views/reports/payment-generator.html'"></div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
         ...
         <div class="label-primary row p-sm h6 text-white">

             <span  data-ng-show="reports.dateRange">Date Range : {{reports.dateRange}}</span><span data-ng-show="reports.projectType"> | Project: {{reports.projectType}} </span><span data-ng-show="reports.startDate && reports.dateRange=='period'"> | Start Date :<em>{{reports.startDate | date:'dd-MMM-yyyy' }}</em></span><span data-ng-show="reports.endDate && reports.dateRange=='period'"> | To Date :<em>{{reports.endDate | date:'dd-MMM-yyyy' }}</em> </span>
            ...
            <div class="table-responsive">
                ...
                <table cellspacing="1" cellpadding="1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>Project</th>
                            <th data-ng-show="report.project.value!='all'">Date</th>
                            <th>Total Amount (<app-currency>$</app-currency>)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr data-ng-repeat="projects in generatedList">
                         <td>{{projects.projects.name}}</td>
                         <td data-ng-show="report.project.value!='all'">{{projects.date}}</td>
