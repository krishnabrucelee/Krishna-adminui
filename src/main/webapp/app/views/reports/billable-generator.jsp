...
<form name="billableForm" data-ng-submit="validateBillable(billableForm)" method="post" novalidate="">
    <div class="row">
                    ...
                    <div class="col-md-6  col-sm-6">
                        ...
                        <div class="form-group m-l-md" data-ng-show="report.dateRange.value == 'period'" ng-class="{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7 ">
                                    ...
                                    <div class="error-area" data-ng-show="!report.startDate && formSubmitted" ></div>
                        ...
                        <div class="form-group m-l-md" data-ng-show="report.dateRange.value == 'period'" ng-class="{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7 ">
                                    <div class="input-group">
                                        <input type="text" data-ng-show="report.dateRange.value == 'period'" readonly class="form-control" datepicker-popup="{{global.date.format}}" name="endDate" data-ng-class="{'error': !report.endDate && formSubmitted}" data-ng-model="report.endDate"  is-open="report.endDateOpened" min-date="report.startDate" datepicker-options="global.date.dateOptions"  close-text="Close" />
                                        <span class="input-group-btn">
                                    ...
                                    <div class="error-area" data-ng-show="!report.endDate && formSubmitted" ></div>
                        ...
                        <div class="form-group m-l-md" data-ng-show="report.billable.value == 'selective'" ng-class="{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    ...
                                    <div class="error-area" data-ng-show="!report.selective && formSubmitted" ><i  tooltip="Billable Item is Required" class=""></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
