...
<form name="dueForm" data-ng-submit="validateDue(dueForm)" method="post" novalidate="">
    <div class="row">
                ...
                <div class="row m-t-md">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group m-l-md" ng-class="{
                                            'text-danger'
                                            : dueForm.dateRange.$invalid && formSubmitted}">
                            <div class="row">
                    ...
                    <div class="col-md-6  col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7 ">
                                    <div class="input-group">
                                        <input type="text" readonly data-ng-class="{'error': !report.startDate && formSubmitted}" data-ng-show="report.dateRange.value == 'period'" class="form-control" datepicker-popup="{{global.date.format}}" name="fromDate" data-ng-model="report.startDate" is-open="report.startDateOpened" max-date="report.endDate" datepicker-options="global.date.dateOptions"  close-text="Close" />
                        ...
                        <div class="form-group m-l-md" data-ng-show="report.dateRange.value == 'period'" ng-class="{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7 ">
                                    <div class="input-group">
                                        <input type="text" data-ng-class="{'error': !report.endDate && formSubmitted}" data-ng-class="{'error': !report.endDate && formSubmitted}" data-ng-show="report.dateRange.value == 'period'" readonly class="form-control" datepicker-popup="{{global.date.format}}" name="endDate" data-ng-model="report.endDate" min-date="report.startDate"  is-open="report.endDateOpened" datepicker-options="global.date.dateOptions"  close-text="Close" />
                                        <span class="input-group-btn">
