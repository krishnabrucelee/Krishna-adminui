...
<div class="white-content">
    ...
    <div class="col-md-3 col-sm-4 m-b-md"><button class="btn btn-info box w-100  h-200"  ui-sref="configuration.home.domain" type="button"><i class="fa-3x fa fa-check-square-o"></i> <br/>Domain Config</button></div>
