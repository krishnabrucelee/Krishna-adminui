...
<div class="white-content">
    ...
    <div class="col-md-3 col-sm-4 m-b-md"><button class="btn btn-info box w-100" ui-sref="configuration.home.events" type="button"><i class="fa fa-bell fa-3x"></i> <h5><fmt:message key="theme.notification" bundle="${msg}" /></h5></button></div>
</div>
