        ...
        <div class="col-md-12 col-sm-12">
            <div class="hpanel">
                ...
                <div class="panel-body"><div class="col-md-12 col-sm-12">
                        ...
                        <div class="form-group">
                            <div class="row" >
                                <label class="col-md-2 col-sm-3 control-label "><fmt:message key="theme.page.title" bundle="${msg}" />:</label>
                                <div class="col-md-5 col-sm-7">
                                    <input type="text" class="form-control" name="headerTitle" required="true" data-ng-model="themeSettingsList.headerTitle" >
                                    <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon " tooltip="<fmt:message key="theme.page.title" bundle="${msg}" />" ></i>
                                </div>
                            </div>
                        </div>
