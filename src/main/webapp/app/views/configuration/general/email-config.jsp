                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <span class="pull-left">
                            <a class="btn btn-info" ui-sref="configuration.home({category:'general'})"  title="<fmt:message key="common.back" bundle="${msg}" />" ><span class="fa fa-arrow-circle-left fa-lg "></span> <fmt:message key="common.back" bundle="${msg}" /></a>
                        </span>
                    </div>
            ...
            <div class="panel-body">
                <div class="col-md-6 col-sm-6 border-right">
                    <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.applicationURL.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="application.url" bundle="${msg}" />:
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="url.panel" bundle="${msg}" /> "></i>
                    ...
                    <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.userName.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="common.username" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            ...
                            <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="common.username" bundle="${msg}" />" ></i>
                    ...
                    <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.port.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="port" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="port.number" bundle="${msg}" />" ></i>
                    ...
                    <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.from.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="from" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            ...
                            <div class="col-md-7 col-sm-7">
                                <input required="true" type="email" valid-email name="from" data-ng-model="email.emailFrom" class="form-control" data-ng-class="{ 'error' : emailConfigForm.from.$invalid && formSubmitted}" >
                                 <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="from.address" bundle="${msg}" />" ></i>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.host.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="host" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="host.server" bundle="${msg}" />"></i>
                ...
                <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.password.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="common.password" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="common.password" bundle="${msg}" /> "></i>
                     ...
                     <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.ssl.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="ssl" bundle="${msg}" />:
                            </label>
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="ssl.enable" bundle="${msg}" />" ></i>
                     ...
                     <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.senderName.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="sender.name" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            ...
                            <div class="col-md-7 col-sm-7">
								...
								<i class="pe-7s-help1 pe-lg m-l-n-sm tooltip-icon" tooltip="<fmt:message key="sender.name" bundle="${msg}" />" ></i>
                     ...
                     <div class="form-group" data-ng-class="{ 'text-danger' : emailConfigForm.emailLanguage.$invalid && formSubmitted}">
                        <div class="row">
                            <label class="col-md-3 col-sm-3 control-label"><fmt:message key="select.default" bundle="${msg}" />:
                                <span class="text-danger">*</span>
                            </label>
                            <div class="col-md-7 col-sm-7">
