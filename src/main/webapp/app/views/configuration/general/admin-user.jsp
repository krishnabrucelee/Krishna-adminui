                        ...
                        <div class="pull-right">
                            <div class="quick-search ">
                                <div class="input-group">
                                    <input data-ng-model="adminUserSearch" type="text" class="form-control input-medium" placeholder="Quick Search" aria-describedby="quicksearch-go">
                                    <span class="input-group-addon" id="quicksearch-go"><span class="pe-7s-search pe-lg font-bold"></span></span>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <span class="pull-right m-l-sm m-t-sm">
                                <a class="btn btn-info" ui-sref="configuration.home.add-admin-user"><span class="pe-7s-plus pe-lg font-bold m-r-xs"></span>Add</a>
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-6 col-xs-6">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
