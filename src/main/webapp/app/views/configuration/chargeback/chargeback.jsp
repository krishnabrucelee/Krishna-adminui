...
<div class="white-content">
    ...
    <div class="col-md-3 col-sm-4 m-b-md"><button class="btn btn-info box w-100" ui-sref="configuration.home.billing-settings" type="button"><i class="fa fa-file-text fa-3x"></i> <h5>Adjustments</h5></button></div>
    ...
    <div class="col-md-3 col-sm-4 m-b-md"><button class="btn btn-info box w-100" ui-sref="configuration.home.paymentGateway" type="button"><i class="fa fa-credit-card fa-3x"></i> <h5>Payment Gateway</h5></button></div>
