...
<form name="taxForm" data-ng-submit="saveTax(taxForm)" method="post"
	novalidate="" >
	<div class="inmodal">
		<div class="modal-header">
			<panda-modal-header hide-zone="true" page-icon="fa fa-plus-circle" page-title="<fmt:message key="tax.add" bundle="${msg}" />"></panda-modal-header>
		</div>
