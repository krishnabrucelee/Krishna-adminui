									...
									<form data-ng-submit="searchList(quickSearchText)">
										<div class="quick-search pull-right">
											<div class="input-group">
												<input data-ng-model="quickSearchText" id="company_list_search" type="text" valid-characters class="form-control input-medium" placeholder="<fmt:message key="common.quick.search" bundle="${msg}" />" aria-describedby="quicksearch-go">
                                   ...
                                   <td class="col-md-6 col-sm-6" colspan="7"><fmt:message key="common.no.records.found" bundle="${msg}" />!!</td>
                                        ...
                                        <tbody data-ng-show="domainList.length > 0">
                                            <tr data-ng-class="{'bg-row text-white' : domain.isSelected == true }"  data-ng-repeat="domain in filteredCount = (domainList| filter: quickSearch | orderBy:sort.column:sort.descending)">
                                                ...
                                                <td>
                                                <a class="text-info" id="domain_dashboard_link_{{domain.id}}" ui-sref="client.client.dashboard({id: {{ domain.id }}, view: 'dashboard'})" title="<fmt:message key="view.dashboard" bundle="${msg}" />">
                                                	{{domain.name}}
                                               	</td>
