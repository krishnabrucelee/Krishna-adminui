...
<form name="clientForm" data-ng-submit="validateEdit(clientForm)" method="post" novalidate="" data-ng-controller="clientListCtrl">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group" ng-class="{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input required="true" readonly type="text" name="companyName" data-ng-model="client.companyName"  class="form-control" data-ng-class="{'error': clientForm.companyName.$invalid && formSubmitted}">
                        ...
                        <div class="form-group" ng-class="{
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input required="true" readonly type="text" name="companyNameAbbreviation" data-ng-model="client.companyNameAbbreviation"  class="form-control" data-ng-class="{'error': clientForm.companyNameAbbreviation.$invalid && formSubmitted}">
