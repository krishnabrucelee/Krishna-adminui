...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
	...
	<div class="row" data-ng-show="(paginationObject.totalItems >  (((paginationObject.currentPage - 1) (paginationObject.limit * 1)) + (paginationObject.limit * 1))) || paginationObject.currentPage > 1">
