...
<form name="form.detachForm" data-ng-controller="deleteCtrl">
    <div class="inmodal" >
        <div class="modal-header">
            <panda-modal-header hide-zone="false" page-icon="fa fa-warning" page-title="Confirm Delete"></panda-modal-header>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-default btn-danger2" ng-click="ok(deleteObject)" data-dismiss="modal">Ok</button>
