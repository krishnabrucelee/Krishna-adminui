...
<div class="inmodal" >
    <div class="modal-header">
        <panda-modal-header hide-zone="false" page-icon="fa fa-warning" page-title="<fmt:message key="account.suspension.confirmation" bundle="${msg}" />"></panda-modal-header>
    ...
    <div class="modal-body">
        <div class=" row">
            ...
            <div class="form-group has-error col-md-9 col-sm-9  col-xs-9">
                <p ><fmt:message key="are.you.sure.do.you.want.to.suspend" bundle="${msg}" /> </p>
            </div>
