                    ...
                    <div class="col-md-6 col-sm-6 border-right">
                        ...
                        <div class="form-group" ng-class="{'text-danger': TemplateForm.cost.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-7  col-sm-7 col-xs-7">
                                    <input required="true" type="text" name="cost" valid-decimal data-ng-model="template.cost" class="form-control"  data-ng-class="{'error': TemplateForm.cost.$invalid && formSubmitted}">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6  col-sm-6 col-lg-6  col-sm-6 col-lg-6">
                                    <label> <input icheck type="radio" name= "architecture" ng-checked="template.architecture=='64'" ng-model="template.architecture"> 64 Bit </label>
                                    <label  class="m-l-sm"> <input icheck type="radio" name= "architecture" ng-checked="template.architecture=='32'" ng-model="template.architecture"> 32 Bit</label>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6  col-sm-6 col-lg-6  col-sm-6 col-lg-6">
                                    <label> <input icheck type="checkbox" ng-model="template.passwordEnabled"> <fmt:message key="template.password.enabled" bundle="${msg}" /></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
