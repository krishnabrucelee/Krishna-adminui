                    ...
                    <div class="col-md-6 col-sm-6 border-right">
                        ...
                        <div class="form-group" ng-class="{'text-danger': TemplateForm.cost.$invalid && formSubmitted}">
                            <div class="row">
                                ...
                                <div class="col-md-7  col-sm-7 col-xs-7">
                                    <input required="true" type="text" name="cost" valid-decimal data-ng-model="template.templateCost[0].cost" class="form-control"  data-ng-class="{'error': TemplateForm.cost.$invalid && formSubmitted}">
