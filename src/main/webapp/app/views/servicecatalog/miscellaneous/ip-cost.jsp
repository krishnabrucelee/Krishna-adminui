...
<form name="ipcostForm" data-ng-submit="save(ipcostForm)" data-ng-controller="miscellaneousListCtrl" >
    <div class="row">
                ...
                <div class="white-content">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-4 col-sm-4 control-label font-normal">Cost/IP/month(<app-currency class="text-danger"></app-currency>)</label>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <table cellspacing="1" cellpadding="1" class="table table-bordered  table-striped ">
                                            ...
                                            <tbody >
                                                <tr data-ng-repeat="miscellaneous in miscellaneousList| filter: miscellaneousSearch">
                                                    ...
                                                    <td><app-currency></app-currency>8.00</td>
