...
<form name="loadbalanceForm" data-ng-submit="save(loadbalanceForm)" data-ng-controller="miscellaneousListCtrl" >
    <div class="row">
                ...
                <div class="white-content">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-4 col-sm-4 control-label font-normal">Cost/Policy/month(<app-currency class="text-danger"></app-currency>)</label>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6  col-xs-6">
                                        <button class="btn btn-info pull-right" type="submit" ng-disabled="form.loadbalanceForm.$invalid" >Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table cellspacing="1" cellpadding="1" class="table table-bordered  table-striped ">
                                        ...
                                        <tbody >
                                            <tr data-ng-repeat="miscellaneous in miscellaneousList| filter: miscellaneousSearch">
                                                ...
                                                <td><app-currency></app-currency>2.00</td>
