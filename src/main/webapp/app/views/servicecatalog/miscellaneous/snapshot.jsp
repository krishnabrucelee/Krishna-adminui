...
<form name="snapshotForm" data-ng-submit="save(snapshotForm)" data-ng-controller="miscellaneousListCtrl" >
    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <input  type="text" name="description" valid-decimal data-ng-model="miscellaneous.cost" class="form-control" placeholder="10.00" >
                                    ...
                                    <table cellspacing="1" cellpadding="1" class="table table-bordered  table-striped">
                                        ...
                                        <tbody >
                                            <tr data-ng-repeat="miscellaneous in miscellaneousList| filter: miscellaneousSearch">
                                                ...
                                                <td><app-currency>$</app-currency>0.01667</td>
