...
<form name="portforwardForm" data-ng-submit="save(portforwardForm)" data-ng-controller="miscellaneousListCtrl" >
    <div class="row">
                ...
                <div class="white-content">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-md-4 col-sm-4 control-label font-normal">Cost/Rule/month(<app-currency class="text-danger"></app-currency>)</label>
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6  col-xs-6">
                                        <button class="btn btn-info pull-right" type="submit" ng-disabled="form.portforwardForm.$invalid" >Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
