...
<div class="hpanel">
    <div class="row m-l-sm m-r-sm panel-body">
        ...
        <ul class="nav nav-tabs" data-ng-init="miscellaneousCategory = 'bandwidth'">
            <li class="active"><a href="javascript:void(0)" data-ng-click="miscellaneousCategory = 'bandwidth'" data-toggle="tab"> <i class="fa fa-dashboard"></i> Bandwidth</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" data-ng-class="{'active' : miscellaneousCategory == 'bandwidth'}" id="step1-bandwidth">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/bandwidth.jsp'"></div>
            </div>
            <div class="tab-pane"  data-ng-class="{'active' : miscellaneousCategory == 'snapshot'}" id="step1-snapshot">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/snapshot.jsp'"></div>
            </div>
            <div class="tab-pane"  data-ng-class="{'active' : miscellaneousCategory == 'ipcost'}" id="step1-ipcost">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/ip-cost.jsp'"></div>
            </div>
            <div class="tab-pane"  data-ng-class="{'active' : miscellaneousCategory == 'vmsnapshot'}" id="step1-vmsnapshot">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/vmsnapshot.jsp'"></div>
            </div>
            <div class="tab-pane"  data-ng-class="{'active' : miscellaneousCategory == 'loadbalancer'}" id="step1-loadbalancer">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/loadbalancer.jsp'"></div>
            </div>
            <div class="tab-pane"  data-ng-class="{'active' : miscellaneousCategory == 'portforwarding'}" id="step1-portforwarding">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/portforwarding.jsp'"></div>
            </div>
            <div class="tab-pane"  data-ng-class="{'active' : miscellaneousCategory == 'vpnconnection'}" id="step1-vpnconnection">
                <div data-ng-include src="'views/servicecatalog/miscellaneous/vpnconnection.jsp'"></div>
            </div>
        </div>
    </div>
</div>
