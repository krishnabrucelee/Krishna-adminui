...
<form name="form.detachForm" data-ng-controller="deleteCtrl">
    <div class="inmodal" >
        <div class="modal-header">
            <panda-modal-header id="delete_compute_offer_page_title" hide-zone="false" page-icon="fa fa-trash" page-title="<fmt:message key="common.delete.confirmation" bundle="${msg}" />"></panda-modal-header>
        </div>
