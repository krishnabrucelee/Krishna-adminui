						...
						<form data-ng-submit="searchList(vmSearch)">
							<div class="quick-search pull-right">
								<div class="input-group">
									<input data-ng-model="vmSearch" id="os_template_list_search" type="text" valid-characters class="form-control input-medium" placeholder="<fmt:message key="common.quick.search" bundle="${msg}" />" aria-describedby="quicksearch-go">
                ...
                <table cellspacing="1" cellpadding="1" class="table dataTable table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th data-ng-click="changeSort('osTypeDescription',paginationObject.currentPage)" data-ng-class="sort.descending && sort.column =='osType.description'? 'sorting_desc' : 'sorting_asc' " ><fmt:message key="template.type" bundle="${msg}" /></th>
                            <th data-ng-click="changeSort('zoneName',paginationObject.currentPage)" data-ng-class="sort.descending && sort.column =='zone.name'? 'sorting_desc' : 'sorting_asc' " ><fmt:message key="template.zone" bundle="${msg}" /></th>
                            <th data-ng-click="changeSort('hypervisorName',paginationObject.currentPage)" data-ng-class="sort.descending && sort.column =='hypervisor.name'? 'sorting_desc' : 'sorting_asc' " ><fmt:message key="template.hypervisor" bundle="${msg}" /></th>
...
<!--                      <tr data-ng-repeat="template in filteredCount = (templateList| filter: quickSearch | orderBy:sort.column:sort.descending)">
 -->
                       <tr data-ng-repeat="template in templateList">
                            ...
                            <td>{{ template.hypervisorName}}</td>
                            <td data-ng-if = "template.templateCreationType == false"><b class="text-danger">{{ template.templateCost || 0}}<span data-ng-if = "!template.oneTimeChargeable" >/ day</span></b></td>
