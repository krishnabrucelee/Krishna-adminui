...
<form name="servicecategoryForm" method="POST" data-ng-submit="edit(servicecategoryForm, servicecategory)" novalidate >
<div class="inmodal ">
    <div class="modal-header">
        <panda-modal-header page-icon="fa-file-text fa" hide-zone="false"
			page-title="<fmt:message key="service.category.edit" bundle="${msg}" />">
        </panda-modal-header>
    </div>
     	...
     	<div data-ng-hide="showLoader">
	        <div class="form-group" data-ng-class="{ 'text-danger' : servicecategoryForm.category.$invalid && formSubmitted}">
           	...
           	<div class="row form-group text-center">
				...
				<button class="btn btn-info" data-ng-hide="showLoader" type="submit"><fmt:message key="common.edit" bundle="${msg}" /></button>
           	</div>
	    </div>
    </div>
   </div>
