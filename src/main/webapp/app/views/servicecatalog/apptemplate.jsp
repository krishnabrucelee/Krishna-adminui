                ...
                <table cellspacing="1" cellpadding="1" class="table dataTable table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th data-ng-click="changeSorts('templateCost[0].cost',paginationObject.currentPage)" data-ng-class="sort.descending && sort.column =='templateCost[0].cost'? 'sorting_desc' : 'sorting_asc' " ><fmt:message key="template.cost" bundle="${msg}" />(<app-currency></app-currency>)</th>
