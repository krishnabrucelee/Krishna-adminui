                        ...
                        <div class="col-md-6  col-sm-12 col-xs-4">
                            ...
                            <div class="form-group">
                                <div class="row m-t-md">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <label class="font-normal"> <input icheck type="checkbox"  ng-model="compute.customized" > <fmt:message key="compute.custom" bundle="${msg}" /></label>
                                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4  col-sm-4 col-xs-4">
                                    <select data-ng-init="compute.computeCost.zone = formElements.zoneList[0]" class="form-control input-group" name="zone" data-ng-model="compute.computeCost.zone" ng-options="zone.name for zone in formElements.zoneList" >
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="instanceRunningCostVcpu" data-ng-model="compute.computeCost.instanceRunningCostVcpu" class="form-control" >
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="instanceRunningCostMemory" data-ng-model="compute.computeCost.instanceRunningCostMemory" class="form-control" >
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="instanceRunningCostIops" data-ng-model="compute.computeCost.instanceRunningCostIops" class="form-control" >
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="setupCost" data-ng-model="compute.computeCost.setupCost" class="form-control" >
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="instanceStoppageCostVcpu" data-ng-model="compute.computeCost.instanceStoppageCostVcpu" class="form-control" >
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="instanceStoppageCostMemory" data-ng-model="compute.computeCost.instanceStoppageCostMemory" class="form-control" >
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3  col-sm-3 col-xs-3">
                                    <input  type="text" valid-decimal name="instanceStoppageCostIops" data-ng-model="compute.computeCost.instanceStoppageCostIops" class="form-control" >
